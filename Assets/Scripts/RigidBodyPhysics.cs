...
public static class RigidBodyPhysics
{
    public static void AddForceToReadVelocity(Rigidbody rigidbody, Vector3 velocity, float force = 1f, ForceMode mode = ForceMode.Force)
    {
