...
public class Float : MonoBehaviour
{
        ...
        void Awake()
        {
            Waves = FindObjectOfType<OceanWaves>();
            ...
            centerOffset = RigidBodyPhysics.GetCenter(WaterLinePoints) - transform.position;
        ...
        void FixedUpdate()
        {
            ...
            TargetUp = RigidBodyPhysics.GetNormal(WaterLinePoints);
